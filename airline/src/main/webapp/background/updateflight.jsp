				...
				<div class="maincontentinner">
					<div class="row-fluid">
						<div class="span8" style="margin-left:20%;">
							<form action="../updateFlightAction.action" class="editprofileform"
								method="post">
									...
									<div class="widgetcontent">
										...
										<p>
											<label>航班号：</label> <input type="text" name="flight.flightNumber"
												class="input-xlarge" value="${flight.flightNumber }" />
										</p>
										<p>
											<label>出发地:</label> <input type="text" name="flight.startPoint"
												class="input-xlarge" value="${flight.startPoint }" />
										</p>
										<p>
											<label>到达地:</label> <input type="text"  name="flight.endPoint"
												class="input-xlarge" value="${flight.endPoint }" />
										</p>
										<p>
											<label>出发机场:</label> <input type="text"  name="flight.startPointAirport"
												class="input-xlarge"  value="${flight.startPointAirport }"/>
										</p>
										<p>
											<label>到达机场:</label> <input type="text"  name="flight.endPointAirport"
												class="input-xlarge"  value="${ flight.endPointAirport}"/>
										</p>
										<p>
											<label>出发时间:</label> <input type="text" id="d241" name="startTime"
												onfocus="WdatePicker({skin:'whyGreen',dateFmt:'HH:mm:ss'})"
												class="Wdate" style="width:270px"  value="<s:date name="#session.flight.startTime" format="HH:mm:ss"/>"/>
										</p>
										<p>
											<label>到达时间:</label> <input type="text" id="d241" name="endTime"
												onfocus="WdatePicker({skin:'whyGreen',dateFmt:'HH:mm:ss'})"
												class="Wdate" style="width:270px"  value="<s:date name="#session.flight.arrivalTime" format="HH:mm:ss"/>"/>
										</p>
										<p>
											<label>头等舱价格:</label> <input type="text" style="width:200px" id="d241" name="cabinPrice.firstClass"
												value="${ flight.cabinPrice.firstClass}" />
											 
										</p>
										<p>
											<label>公务舱价格:</label> <input type="text" style="width:200px" id="d241" name="cabinPrice.businessClass"
												 value="${flight.cabinPrice.businessClass }"/>
										     
										</p>
										<p>
											<label>经济舱价格:</label> 
											<input type="text" style="width:200px" id="d241" name="cabinPrice.touristClass"
												 value="${flight.cabinPrice.touristClass }"/>
											
										</p>
										<p>
											<label>机型:</label> 
											<span><s:property value="#session.flight.planemodel.planeModelCode"/> </span>
											<select name="planeModelCode">
										...
										<p align="center">
										    <input type="text" name="flightId" value="${flight.flightId }" style="display: none;">

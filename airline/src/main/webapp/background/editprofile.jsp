									...
									<div class="widgetcontent">
										...
										<p>
											<label>用户名：</label> <input type="text" name="username"
												class="input-xlarge" value="${admin2.username }" disabled="disabled" />
										</p>
										<p>
											<label>当前密码:</label> <input type="text" name="password"
												class="input-xlarge" value="" />
										</p>
										<p>
											<label>新密码:</label> <input type="text" name="location"
												class="input-xlarge" value="" />
										</p>
										<p>
											<label>确认密码:</label> <input type="text" name="website"
												class="input-xlarge" value="" />
										</p>
										<p align="center">
